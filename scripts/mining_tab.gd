...
func _select_random_ore() -> void:
	# Use GameManager's get_random_ore() - already implements probability-based selection
...
func _refresh_probability_list() -> void:
	...
	# Display each ore's probability (sorted descending)
