...
## GameConfig.gd - Game balance constants manager
## Manage all magic numbers in one place to reduce coupling
...
const ANVIL_COMMON_MIN = 5.0  # minimum common grade chance
...
# ============================================
## Unlock conditions per tier: required hired count & minimum level
